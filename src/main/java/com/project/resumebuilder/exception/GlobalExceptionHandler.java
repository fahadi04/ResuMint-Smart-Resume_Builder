...
public class GlobalExceptionHandler {
    ...
    public ResponseEntity<Map<String, Object>> handleValidationExceptions(MethodArgumentNotValidException ex) {
        log.info("Inside GlobalExceptionHandler - handelValidationExceptions()");
    ...
    public ResponseEntity<Map<String, Object>> handleResourceExistsException(ResourceExistsException ex) {
        ...
        Map<String, Object> response = new HashMap<>();
        response.put("message", "Resource exists already..!!!");
    ...
    public ResponseEntity<Map<String, Object>> handleGenericException(Exception ex) {
        log.info("Inside GlobalExceptionhHandler - handleGenericException()");
        Map<String, Object> response = new HashMap<>();
